        ...
        <div className="space-y-6">
          <div className="bg-slate-800/50 backdrop-blur rounded-2xl p-6 border border-white/5 h-full">
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-xl bg-slate-700/30 border border-green-500/20">
                <div className="flex items-center justify-between mb-2">
                  <h4 className="font-bold text-green-400">Support Admin</h4>
                  <span className="px-2 py-0.5 rounded text-xs bg-green-500/10 text-green-300 border border-green-500/20">Views Only</span>
                </div>
                <ul className="text-xs text-slate-400 space-y-1 list-disc list-inside">
